...
const Newcar = () => {
  ...
  return (
    <div className={`${styles.cnt} container-fluid vh-100 d-flex flex-column align-items-center`}>
      <div className={`${styles.textctn} align-items-center`}>
        <h2 className={`${styles.zindex} fs-1 d-flex text-white `}>Add Car</h2>
        <p className={`${styles.zindex} fs-5 d-flex text-white text-center`}>
