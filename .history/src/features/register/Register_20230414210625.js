...
const Register = () => {
  ...
  const sendForm = async (e) => {
    ...
    axios.get('https://dreamcars.onrender.com/api/v1/users', signupOptions);
    .then((response))
    ...
    const dataResponse = axios.get('https://dreamcars.onrender.com/api/v1/users/sign_in', loginOptions);
    if (dataResponse.ok) {
