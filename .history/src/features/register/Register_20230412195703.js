...
//     const dataResponse = await fetch('https://dreamcars.onrender.com/api/v1/users/login', loginOptions);
//     if (dataResponse.ok) {
...
//           <span 
/               className={isActive ? 'error-message' : 'error-message active'}>This username or email already exists </span>
//           <input
//             ref={name}
//             type="text"
//             id="name"
