...
//   return (
//     <div//className={`${styles.container} container-fluid vw-100 d-flex flex-column align-items-center justify-content-center`}
//     >
...
const LoginScreen = () => {
  ...
  const sendForm = async () => {
    ...
    const dataResponse = await fetch('https://dreamcars.onrender.com/api/v1/login', requestOptions);
    if (dataResponse.ok) {
