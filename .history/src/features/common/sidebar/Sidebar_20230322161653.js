      ...
      <div className="vh-100 overflow-auto w-100">
        <div className={`${styles.navbarContainer} vh-100 pt-5`}>
          <div className="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start">
            ...
            <ul
              className="nav nav-pills flex-sm-column flex-row flex-nowrap flex-shrink-1 flex-sm-grow-0 flex-grow-1 mb-sm-auto mb-1 justify-content-center align-items-center align-items-sm-start"
              id="menu"
            >
              <li className="w-100">
