...
> Car Rental is a react frontend application for booking car of your dreams for a few days. This application serves as user interface for the backend and users can add, and delete Cars for rental, as well as add reservations. Users must sign up and sign in to be able to book a car.
